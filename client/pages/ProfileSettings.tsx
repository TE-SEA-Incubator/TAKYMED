...
export default function ProfileSettings() {
  ...
  useEffect(() => {
    if (!user?.id) return;
    fetch("http://dev.takymed.com/api/notifications/preferences", {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    setIsSaving(true);
    try {
      const response = await fetch("http://dev.takymed.com/api/auth/profile", {
        method: "PATCH",
        headers: {
  ...
  const handleSaveNotifications = async () => {
    ...
    try {
      ...
      const res = await fetch("http://dev.takymed.com/api/notifications/preferences", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "x-user-id": user.id.toString(),
