...
export default function Checkout() {
  ...
  useEffect(() => {
    async function fetchAccountTypes() {
      try {
        const res = await fetch("https://dev.takymed.comhttps://dev.takymed.com/api/admin/settings", {
  ...
  const handleSendOtp = async () => {
    ...
    setProcessing(true);
    try {
      const res = await fetch("https://dev.takymed.comhttps://dev.takymed.com/api/payments/send-otp", {
        method: "POST",
        headers: { 
  ...
  const handlePayment = async () => {
    ...
    try {
      const res = await fetch("https://dev.takymed.comhttps://dev.takymed.com/api/payments/process", {
        method: "POST",
        headers: { 
          "Content-Type": "application/json",
          "x-user-id": user?.id?.toString() || ""
